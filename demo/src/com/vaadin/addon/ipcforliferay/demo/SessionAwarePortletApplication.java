 ...
 */
public class SessionAwarePortletApplication extends Application {
    ...
    /**
     * Initialize the application. Subclasses must call this method in their
     * {@link #init()} methods.
     */
    @Override
    public void init() {
    ...
    /**
     * Returns the current portlet application context.
     * 
