...
public class SenderUI extends SessionAwarePortletUI {
     ...
     * @param age
     */
    public void sendPersonViaSession(String firstName, String lastName,
            int age) {
